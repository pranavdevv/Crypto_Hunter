...
export function GlitchBuyButton_Jitter(props: { symbol: string } & React.ButtonHTMLAttributes<HTMLButtonElement>) {
    return (
        <Button
            variant="default"
            className="w-full bg-green-600 hover:bg-green-700 animate-[bounce_0.2s_infinite]"
            {...props}
        >
            BUY {props.symbol}
        </Button>
...
export function GlitchBuyButton_Reverse(props: { symbol: string, onSell?: () => void } & React.ButtonHTMLAttributes<HTMLButtonElement>) {
    return (
        <Button
            variant="default"
